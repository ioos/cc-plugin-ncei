...
class TestNCEITrajectoryProfile1_1(NCEITestCase):
    def setUp(self):
        self.run_checker(
            "ncei-trajectory-profile-orthogonal:1.1",
            STATIC_FILES["nodc-trajectory-profile"],
        )
...
class TestNCEITrajectoryProfile2_0(NCEITestCase):
    def setUp(self):
        self.run_checker(
            "ncei-trajectory-profile-orthogonal:2.0",
            STATIC_FILES["ncei-trajectory-profile-orthogonal:2.0"],
        )
