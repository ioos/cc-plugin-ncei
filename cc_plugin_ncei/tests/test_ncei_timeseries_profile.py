...
class TestNCEITimeSeriesProfile1_1(NCEITestCase):
    def setUp(self):
        self.run_checker(
            "ncei-timeseries-profile-orthogonal:1.1",
            STATIC_FILES["nodc-timeseries-profile"],
        )
...
class TestNCEITimeSeriesProfile2_0(NCEITestCase):
    def setUp(self):
        self.run_checker(
            "ncei-timeseries-profile-orthogonal:2.0",
            STATIC_FILES["ncei-timeseries-profile-orthogonal:2.0"],
        )
