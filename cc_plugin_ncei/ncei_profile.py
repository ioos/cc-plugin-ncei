...
class NCEIProfileOrthogonalBase(BaseCheck):
    ...
    def check_profile_id(self, dataset):
        ...
        test_ctx = TestCtx(
            BaseCheck.MEDIUM,
            f"Recommended attributes for the {profile_ids[0].name} variable",
        )
...
class NCEIProfileOrthogonal1_1(NCEI1_1Check, NCEIProfileOrthogonalBase):
    ...
    def check_required_attributes(self, dataset):
        ...
        required_ctx = TestCtx(
            BaseCheck.HIGH,
            "Required Global Attributes for Profile-orthogonal dataset",
        )
        required_ctx.assert_true(
...
class NCEIProfileIncomplete1_1(NCEI1_1Check, NCEIProfileIncomplete):
    ...
    def check_required_attributes(self, dataset):
        ...
        required_ctx = TestCtx(
            BaseCheck.HIGH,
            "Required Global Attributes for Profile-incomplete dataset",
        )
        required_ctx.assert_true(
            getattr(dataset, "nodc_template_version", "").lower()
            == self.valid_templates[0].lower(),
