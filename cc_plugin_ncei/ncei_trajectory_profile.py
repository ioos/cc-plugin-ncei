...
class NCEITrajectoryProfileOrthogonalBase(BaseCheck):
    ...
    def check_trajectory_id(self, dataset):
        ...
        test_ctx = TestCtx(
            BaseCheck.MEDIUM,
            f"Recommended attributes for the {trajectory_ids[0].name} variable",
        )
...
class NCEITrajectoryProfileOrthogonal1_1(
    NCEI1_1Check,
    ...
    def check_required_attributes(self, dataset):
        ...
        required_ctx = TestCtx(
            BaseCheck.HIGH,
            "Required Global Attributes for Trajectory Profile orthogonal dataset",
        )
        required_ctx.assert_true(
...
class NCEITrajectoryProfileOrthogonal2_0(
    NCEI2_0Check,
    NCEITrajectoryProfileOrthogonalBase,
):
    register_checker = True
...
class NCEITrajectoryProfileIncomplete1_1(
    NCEI1_1Check,
    ...
    def check_required_attributes(self, dataset):
        ...
        required_ctx = TestCtx(
            BaseCheck.HIGH,
            "Required Global Attributes for Trajectory Profile incomplete dataset",
        )
        required_ctx.assert_true(
            getattr(dataset, "nodc_template_version", "").lower()
            == self.valid_templates[0].lower(),
...
class NCEITrajectoryProfileIncomplete2_0(
    NCEI2_0Check,
    NCEITrajectoryProfileIncompleteBase,
):
    register_checker = True
