...
class NCEITimeSeriesProfileOrthogonalBase(BaseCheck):
    ...
    def check_dimensions(self, dataset):
        ...
        message += " coordinate variable with dimension (z)."

        for variable in util.get_geophysical_variables(dataset):
            is_valid = util.is_timeseries_profile_single_station(
                dataset,
                variable,
            )
            is_valid = is_valid or util.is_timeseries_profile_multi_station(
                dataset,
                variable,
            )
    ...
    def check_timeseries_id(self, dataset):
        ...
        exists_ctx = TestCtx(
            BaseCheck.MEDIUM,
            'Variable defining "timeseries_id" exists',
        )
        ...
        exists_ctx.assert_true(
            timeseries_ids,
            'variable defining cf_role="timseries_id" exists',
        )
        ...
        test_ctx = TestCtx(
            BaseCheck.MEDIUM,
            f"Recommended attributes for the {timeseries_ids[0].name} variable",
        )
...
class NCEITimeSeriesProfileOrthogonal1_1(
    NCEI1_1Check,
    ...
    def check_required_attributes(self, dataset):
        ...
        required_ctx = TestCtx(
            BaseCheck.HIGH,
            "Required Global Attributes for Timeseries Profile orthogonal dataset",
        )
        required_ctx.assert_true(
...
class NCEITimeSeriesProfileOrthogonal2_0(
    NCEI2_0Check,
    NCEITimeSeriesProfileOrthogonalBase,
):
    register_checker = True
...
class NCEITimeSeriesProfileOrthTimeIncompleteDepth1_1(
    NCEI1_1Check,
...
class NCEITimeSeriesProfileOrthTimeIncompleteDepth2_0(
    NCEI2_0Check,
    NCEITimeSeriesProfileOrthTimeIncompleteDepthBase,
):
    register_checker = True
...
class NCEITimeSeriesProfileIncompleteBase(BaseCheck):
    ...
    def check_dimensions(self, dataset):
        ...
        message = (
            "{} must be a valid timeseries-profile-incomplete feature type."
        )
...
class NCEITimeSeriesProfileIncomplete1_1(
    NCEI1_1Check,
    ...
    def check_required_attributes(self, dataset):
        ...
        required_ctx = TestCtx(
            BaseCheck.HIGH,
            "Required Global Attributes for Timeseries Profile Incomplete dataset",
        )
        required_ctx.assert_true(
            getattr(dataset, "nodc_template_version", "").lower()
            == self.valid_templates[0].lower(),
...
class NCEITimeSeriesProfileIncomplete2_0(
    NCEI2_0Check,
    NCEITimeSeriesProfileIncompleteBase,
):
    register_checker = True
...
class NCEITimeSeriesProfileIncompleteTimeOrthDepth1_1(
    NCEI1_1Check,
...
class NCEITimeSeriesProfileIncompleteTimeOrthDepth2_0(
    NCEI2_0Check,
    NCEITimeSeriesProfileIncompleteTimeOrthDepthBase,
):
    register_checker = True
